...
static void Init_ADC(void)
{
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA, ENABLE);
		GPIO_InitTypeDef adc_init;
	   adc_init.GPIO_Pin = GPIO_Pin_0;
	   adc_init.GPIO_Mode = GPIO_Mode_AN;
	   adc_init.GPIO_PuPd = GPIO_PuPd_NOPULL;
	   GPIO_Init(GPIOA, &adc_init);
}
...
static void Init_buzzer(void)
{
    ...
    buzzer_init.GPIO_Speed = GPIO_Speed_50MHz;
    buzzer_init.GPIO_PuPd = GPIO_PuPd_NOPULL;
    buzzer_init.GPIO_Pin = GPIO_Pin_2;
